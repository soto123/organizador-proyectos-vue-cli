<template>
  ...
  <div class="proyectos row h-100 d-inline-block w-100 p-1">
    <div class="col-12 d-inline-block text-left pt-3"> <h1> PROYECTOS </h1> </div>
        ...
        <div class="col-md-12 p-0">
            <table class="table table-striped">
                ...
                <tbody class="" id="contenido-tabla">
                    <proyecto-fila-proyecto v-for="item in proyectos" v-bind:key="item.id" v-bind:proyecto="item" v-bind:estados="estados" v-on:cargar_proyecto="cargar_proyecto(item)" v-on:eliminar_proyecto="eliminar_proyecto(item)"></proyecto-fila-proyecto>					
                </tbody>
            </table>
        </div>
    </div>
